...
import pandas as pd
read_file = pd.read_csv (r'J:/Transfer/cchimenti/Test/ExpDevis.csv',delimiter=";", encoding='latin1')
read_file.to_excel (r'J:/Transfer/cchimenti/Test/ExpDevis.xlsx', index = None, header=True)
