...
import pandas as pd
read_file = pd.read_csv (r'L:/KL_CO/110_HYFR/AFFAIRES 2022/HYFR_DC_FC_2022/ExpDevis.csv',delimiter=";", encoding='latin1')
read_file.to_excel (r'L:/KL_CO/110_HYFR/AFFAIRES 2022/HYFR_DC_FC_2022/ExpDevis.xlsx', index = None, header=True)
...
OI_Year=f"=IF(Data!$Q133=\"\",\"\",YEAR(Data!$Q133))"
OI_Month=f"=IF(Data!$Q133=\"\",\"\",MONTH(Data!$Q133))"
...
données_commande=[split,cw_order,OI_Year,OI_Month,date_comande,n_commande,montant_commande]
